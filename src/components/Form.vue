                    ...
                    <div class="row mb-3">
                        <div class="col-sm-6">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="isAustralian" @blur="() => validateResident(true)" @input="() => validateResident(false)" v-model="formData.isAustralian">
...
const validateResident = (blur) => {
    if (!formData.value.isAustralian) {
        if (blur) errors.value.isAustralian = "You must select this option.";
    } else {
...
const validateGender = (blur) => {
    if (!formData.value.gender) {
        if (blur) errors.value.gender = "You must select one option.";
    } else {
...
const validateReason = (blur) => {
    ...
    if (!text) {
        ...
        if (blur) errors.value.reason = "At least 10 characters.";
    } else {
